...
export default function Cta() {
  const stats = [
    ...
    { value: "99.8%", label: "Fleet Availability", icon: Shield },
    { value: "24/7", label: "Fleet Support", icon: Clock },
    { value: "1000+", label: "Premium Vehicles", icon: Car }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of successful companies who trust ProFleet Rentals for their business transportation needs. 
                Get a custom fleet solution tailored to your business requirements.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading corporations and fleet managers nationwide
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Short-term and long-term leasing options available
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Full insurance and maintenance included in all packages
              </p>
            </div>
            
            <div className="space-y-2">
              <div className="size-12 mx-auto rounded-full bg-secondary/10 flex items-center justify-center mb-3">
                <Car className="size-6 text-secondary" />
              </div>
              <h3 className="font-semibold">Premium Fleet</h3>
              <p className="text-sm text-muted-foreground">
                Latest model vehicles maintained to highest standards
              </p>
            </div>
          </div>
        </div>
